...
class MWHttpRequest {
	...
	protected $sslVerifyCert = false;  // don't need to verify for now
	...
	public static function factory( $url, $options = null, $caller = __METHOD__ ) {
		if ( !Http::$httpEngine ) {
			global $wgUseCurlHttpEngine;
			Http::$httpEngine = ($wgUseCurlHttpEngine && function_exists( 'curl_init' )) ? 'curl' : 'php';
